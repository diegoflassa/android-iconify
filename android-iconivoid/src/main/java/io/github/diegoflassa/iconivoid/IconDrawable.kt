...
import io.github.diegoflassa.iconivoid.IconiVoid.findIconForKey
import io.github.diegoflassa.iconivoid.IconiVoid.findTypefaceOf
        ...
        val descriptor = findTypefaceOf(icon)
            ?: throw IllegalStateException(
                "Unable to find the module associated " +
                        ...
                        "you are trying to use with iconivoid.with(...) in your Application?"
            )
